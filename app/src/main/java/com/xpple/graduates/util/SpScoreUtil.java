...
public class SpScoreUtil {
    ...
    private String SCORE_BOOLEAN = "score_boolean"; //是否有记录
    private String SCORE_LOAD = "score_load"; //读档次数

    private String SCORE_HEALTHY = "score_healthy"; //健康
    private String SCORE_MONEY = "score_money"; //金钱
    private String SCORE_ABILITY = "score_ability"; //能力
    private String SCORE_EXPERIENCE = "score_experience"; //经验
    private String SCORE_HAPPY = "score_happy"; //快乐
    private String SCORE_MORALITY = "score_morality"; //道德
    private String SCORE_COMMUNICATION = "score_communication"; //交际

    private String SCORE_MONTH = "score_month"; //剩余月
    private String SCORE_TIME = "score_time"; //剩余时间

    private String SCORE_STOCK = "score_stock"; //股票
    private String SCORE_POSITION = "score_position"; //职位
    private String SCORE_HOUSE = "score_house"; //房产
    private String SCORE_CAR = "score_car"; //汽车
    private String SCORE_PARTNER = "score_partner"; //伴侣

    private String SCORE_CAREER = "score_career"; //事业指数
    private String SCORE_LOVE = "score_love"; //爱情指数

    private String SCORE_RANDOM_STOCK = "score_random_stock"; //随机股票指数

    private String SCORE_INDEX_HOUSE = "score_index_house"; //房价指数
    private String SCORE_INDEX_STOCK = "score_index_stock"; //股票指数

    private String SCORE_PURITY = "score_purity"; //分数含金量
    private String SCORE_INCOME = "score_income"; //月净收益
    private String SCORE_COMMUNICATION_MONTHLY = "score_communication_monthly"; //月净交际
    private String SCORE_HAPPY_MONTHLY = "score_happy_monthly"; //月净快乐

    private String GAME_STOCK = "game_stock"; //股票 0/1
    private String GAME_POSITION = "game_position"; //职位 0/1
    private String GAME_HOUSE = "game_house"; //房产 0/1
    private String GAME_CAR = "game_car"; //汽车 0/1
    private String GAME_PARTNER = "game_partner"; //伴侣 0/1
    private String GAME_LOTTERY = "game_lottery"; //彩票 0/1

    private String GAME_YD = "game_yd"; //30
    private String GAME_BL = "game_bl"; //30
    private String GAME_TS = "game_ts"; //20
    private String GAME_PY = "game_py"; //30
    private String GAME_GJ = "game_gj"; //30
    private String GAME_CM = "game_cm"; //30
    private String GAME_CJ = "game_cj"; //30
    private String GAME_ZJ = "game_zj"; //30
    private String GAME_JB = "game_jb"; //20
    private String GAME_SW = "game_sw"; //20
    private String GAME_TY = "game_tx"; //30
    private String GAME_HJ = "game_hj"; //30

    private String PARTNER_STORY = "partner_story"; //当前剧情人物
    private String PARTNER_XY = "PARTNER_xy"; //小樱
    private String PARTNER_SS = "PARTNER_ss"; //施施
    private String PARTNER_AC = "PARTNER_ac"; //阿婵
    private String PARTNER_ZJ = "PARTNER_zj"; //昭君
    private String PARTNER_SN = "PARTNER_sn"; //十娘
    private String PARTNER_FY = "PARTNER_fy"; //飞燕
