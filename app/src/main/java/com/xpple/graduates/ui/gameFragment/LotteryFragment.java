...
public class LotteryFragment extends BaseFragment {
    ...
    private void setUpViews() {
        btn_lottery = (Button) parentView.findViewById(R.id.btn_lottery);
        iv_lottery = (ImageView) parentView.findViewById(R.id.iv_lottery);
    }
        ...
        btn_lottery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (n.equals(1)) {
                    ...
                    showPopWindows(iv_lottery, "一等奖", "5000000");

                } else if (n.equals(11) || n.equals(12)) {
                    CustomApplication.playSound(R.raw.lottery);
                    showPopWindows(iv_lottery, "二等奖", "500000");

                } else if (11 >= n && n <= 20) {
                    CustomApplication.playSound(R.raw.lottery);
                    showPopWindows(iv_lottery, "三等奖", "50000");
