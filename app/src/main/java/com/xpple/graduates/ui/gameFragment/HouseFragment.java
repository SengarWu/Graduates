...
public class HouseFragment extends BaseFragment implements View.OnClickListener {
    ...
    private Button btn_house_0, btn_house_1, btn_house_2, btn_house_3, btn_house_4, btn_house_5, btn_house_6, btn_house_7;
    ...
    private void setUpViews() {
        ...
        btn_house_0 = (Button) parentView.findViewById(R.id.btn_house_0);
        btn_house_1 = (Button) parentView.findViewById(R.id.btn_house_1);
        btn_house_2 = (Button) parentView.findViewById(R.id.btn_house_2);
        btn_house_3 = (Button) parentView.findViewById(R.id.btn_house_3);
        btn_house_4 = (Button) parentView.findViewById(R.id.btn_house_4);
        btn_house_5 = (Button) parentView.findViewById(R.id.btn_house_5);
        btn_house_6 = (Button) parentView.findViewById(R.id.btn_house_6);
        btn_house_7 = (Button) parentView.findViewById(R.id.btn_house_7);
        setListener();
    }
    ...
    private void onViewShow(Integer my_house) {
        ...
        switch (my_house) {
            ...
            case 1:
                btn_house_0.setVisibility(View.VISIBLE);
                btn_house_0.setText(R.string.sell);
                break;
            case 2:
                btn_house_1.setVisibility(View.VISIBLE);
                btn_house_1.setText(R.string.sell);
                break;
            case 3:
                btn_house_2.setVisibility(View.VISIBLE);
                btn_house_2.setText(R.string.sell);
                break;
            case 4:
                btn_house_3.setVisibility(View.VISIBLE);
                btn_house_3.setText(R.string.sell);
                break;
            case 5:
                btn_house_4.setVisibility(View.VISIBLE);
                btn_house_4.setText(R.string.sell);
                break;
            case 6:
                btn_house_5.setVisibility(View.VISIBLE);
                btn_house_5.setText(R.string.sell);
                break;
            case 7:
                btn_house_6.setVisibility(View.VISIBLE);
                btn_house_6.setText(R.string.sell);
                break;
            case 8:
                btn_house_7.setVisibility(View.VISIBLE);
                btn_house_7.setText(R.string.sell);
                break;
            default:
                break;
        }
        tv_house.setText("" + (index_house) + "%");
