...
public class SettingsFragment extends BaseFragment implements View.OnClickListener {
    ...
    private Button btn_about, btn_suggest, btn_splash, btn_update;
    ...
    private void setUpViews() {
        ...
        btn_splash = (Button) parentView.findViewById(R.id.btn_splash);
        btn_about = (Button) parentView.findViewById(R.id.btn_abont);
        btn_suggest = (Button) parentView.findViewById(R.id.btn_suggent);
        btn_update = (Button) parentView.findViewById(R.id.btn_update);
        setListener();
    }
