...
public class PositionFragment extends BaseFragment implements View.OnClickListener {
    ...
    private Button btn_position_0, btn_position_1, btn_position_2, btn_position_3, btn_position_4, btn_position_5, btn_position_6, btn_position_7, btn_position_8, btn_position_9, btn_position_10, btn_position_11;
    ...
    private void setUpViews() {
        btn_position_0 = (Button) parentView.findViewById(R.id.btn_position_0);
        btn_position_1 = (Button) parentView.findViewById(R.id.btn_position_1);
        btn_position_2 = (Button) parentView.findViewById(R.id.btn_position_2);
        btn_position_3 = (Button) parentView.findViewById(R.id.btn_position_3);
        btn_position_4 = (Button) parentView.findViewById(R.id.btn_position_4);
        btn_position_5 = (Button) parentView.findViewById(R.id.btn_position_5);
        btn_position_6 = (Button) parentView.findViewById(R.id.btn_position_6);
        btn_position_7 = (Button) parentView.findViewById(R.id.btn_position_7);
        btn_position_8 = (Button) parentView.findViewById(R.id.btn_position_8);
        btn_position_9 = (Button) parentView.findViewById(R.id.btn_position_9);
        btn_position_10 = (Button) parentView.findViewById(R.id.btn_position_10);
        btn_position_11 = (Button) parentView.findViewById(R.id.btn_position_11);
        setListener();
    }
    ...
    public void setValue(Integer value, Integer mMoneyValue, Integer mAbilityValue, Integer mExperienceValue,
