    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.rb_start_0:
                showImageChooseViewDialog(R.string.start_b_0, R.string.start_b_0_0, R.mipmap.ic_launcher, new Button1onClickListener() {
                    @Override
                    public void onClick() {
            ...
            case R.id.rb_start_1:
                showImageChooseViewDialog(R.string.start_b_1, R.string.start_b_1_0, R.mipmap.ic_launcher, new Button1onClickListener() {
                    @Override
                    public void onClick() {
                        // TODO Auto-generated method stub
                    }
            ...
            case R.id.rb_start_2:
                showImageChooseViewDialog(R.string.start_b_2, R.string.start_b_2_0, R.mipmap.ic_launcher, new Button1onClickListener() {
                    @Override
                    public void onClick() {
                        // TODO Auto-generated method stub
                    }
            ...
            case R.id.rb_start_3:
                showImageChooseViewDialog(R.string.start_b_3, R.string.start_b_3_0, R.mipmap.ic_launcher, new Button1onClickListener() {
                    @Override
                    public void onClick() {
                        // TODO Auto-generated method stub
                    }
            ...
            case R.id.rb_start_4:
                showImageChooseViewDialog(R.string.start_b_4, R.string.start_b_4_0, R.mipmap.ic_launcher, new Button1onClickListener() {
                    @Override
                    public void onClick() {
                        // TODO Auto-generated method stub
                    }
