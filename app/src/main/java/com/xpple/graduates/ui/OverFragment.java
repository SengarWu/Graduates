...
public class OverFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void setUpViews() {
        ...
        tv_over = (Button) parentView.findViewById(R.id.tv_over);
    }
    ...
    private void uploadScore() {
        ...
        if (isLoggedIn) {
            KTLeaderboard.reportScore(getScore(), "_Score", onReportScoreListener);
        } else {
    ...
    private String makeScoreInfo() {
        return "你现在是" + mPositionString[mPositionValue] + "。"
                ...
                + ((mHealthyValue > 5) ? "你的健康程度一般，大病没有，小病不断。 你的健康程度很差，身体弱不禁风，经常感冒，经常熬夜和饮食起居不规律带来身体的许多疾病。   你的健康程度很差，三十岁就开始秃顶掉头发，身体也已将发福，高血压高血脂带来身体的许多疾病。" : "你非常强壮，健康状态超级棒！")
                + ((mHealthyValue > 5) ? "要注意多运动和有规律的生活。" : "你很注意自己的健康，大量系统的健身运动加上平时的良好生活习惯造就了你运动员般的体魄！")
                + ((mHealthyValue > 5) ? "要注意养成健康的生活方式，多运动提高体质同时保持良好的心态。  你非常注意消费和积累的平衡，通过勤奋工作和不断学习提升自己以谋求更好的待遇和职位，" : "你平时很注意消费和积累的平衡，由于勤奋工作获得升职加薪，")
                + ((mHealthyValue > 5) ? "你平时出手大方，花钱也没什么计划，投资也可能碰到失败，所以经济方面存款不多，仅够糊口。 好运气加上大胆的投资，经济方面可以说是非常富有，钱对你来说只是个符号。好运气加上大胆的投资，经济方面可以列入富豪阶层，" : "投资方面颇有头脑，经济方面可以过上小资的生活。")
                + ((mHealthyValue > 5) ? "你非常注意消费和积累的平衡，通过勤奋工作和不断学习提升自己以谋求更好的待遇和职位，好运气加上大胆的投资，经济方面可以说是辉煌，年纪轻轻就成为亿万富翁！ 你平时也注意消费和积累的平衡，但总是心有余力不足，你埋怨自己不太走运，所以经济方面存款不多，只能温饱。" : "你通过勤奋工作、健身运动、阅读大量书籍、参加众多的学习培训来提升自己，")
                + ((mAbilityValue > 5) ? "能力方面比较强，可以独当一面，开拓守成，经验方面比较丰富。" : "在能力方面非常强，世界上几乎没有什么事情你办不了，经验方面非常丰富，")
                + ((mPositionValue > 5) ? "也担任经理一级的职务" : "就算是总经理的位子你也可以胜任。)")
                + ((mCareerValue > 5) ? " 虽然你还在替别人打工，" : "你通过努力扩大人脉和积累资本，终于创立了属于自己的公司。")
                + ((mHealthyValue > 5) ? "" : "但你对自己的将来还是充满期待。你的生活和工作平衡处理得非常好，")
                + ((mHappyValue > 5) ? "长时间和大工作量的工作学习使你的生活压力很大，经常愁眉不展，觉得整个世界都是灰色的。为了避免你以后忧郁过度而自杀，一定要注意保持快乐的心态。" : "特喜欢玩和喜欢热闹，每天都开开心心的，笑容常在，并给周围的人带来欢乐，")
                + ((mMoralityValue > 5) ? "你平时喜欢赚小便宜，在对待金钱和欲望的问题上不能很好的把握自己，当然，你有时间也会抽空回家看看父母。" : "所有的人都羡慕和喜欢你！你为人非常正直，酒色财气几乎不沾，对自己欲望的控制和把握做得非常好，")
                + ((mMoralityValue > 5) ? "你为人比较正直，能很好的把握和控制自己的欲望，还时常献一下爱心。经常回家看看，对父母还是能尽到必要的孝道。" : "你为人比较正直，能很好的把握和控制自己的欲望，还时常献一下爱心。 对父母则孝敬有加，富有爱心，是个人人称道的好人！你在人际关系方面可以说得上是个中高手，情商非常高哦！")
                + ((mCommunicationValue > 5) ? "你的人际关系方面处理得很糟糕，身边没有几个朋友，经常是行单影孤的。你应该尝试着大方一点，毕竟在这个社会中有朋友才能相互温暖。  你在人际处理方面一般，来来去去也就那么几个酒肉朋友。你可以多参加一点集体活动，增加自己的人际接触面" : "有众多朋友同事的帮助，你如鱼得水，左右逢源。可谓是人见人爱，花见花开，车见车载。")
